...
public class Get07 extends JsonPlaceHolderBaseUrl {
    ...
    public void get01(){
        ...
        List<Integer> ids=json.getList("findAll{it.id>190}.id");//Groovy Language= Java temelli bir programlama dili (id'si 190dan buyuk olanların id'sinin list yaptık)
